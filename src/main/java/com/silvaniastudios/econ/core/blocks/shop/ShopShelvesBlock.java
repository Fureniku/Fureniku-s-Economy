...
public class ShopShelvesBlock extends ShopBaseBlock {
	
	public static final PropertyDirection ROTATION = BlockHorizontal.FACING;

	public ShopShelvesBlock(String name, int shopSize, int shopGuiID) {
		super(name);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		openGui(world, pos, player, EconConstants.Gui.SHOP_SHELVES_FULL);
		return true;
	}

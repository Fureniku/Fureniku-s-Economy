package com.silvaniastudios.econ.core.blocks.shop.containers;
...
public class ShelvesFullContainer extends ShopContainerBase {
	...
	public ShelvesFullContainer(InventoryPlayer invPlayer, ShopBaseEntity tileEntity) {
		...
		addSlotToContainer(new SlotItemHandler(itemHandler, 0,   8,  5));
		addSlotToContainer(new SlotItemHandler(itemHandler, 1,   8, 31));
		addSlotToContainer(new SlotItemHandler(itemHandler, 2, 152,  5));
		addSlotToContainer(new SlotItemHandler(itemHandler, 3, 152, 31));

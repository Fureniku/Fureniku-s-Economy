...
public enum EnumLogType {
	...
	CUSTOMER_START_CART(11, "customer_start_cart", TextFormatting.DARK_GREEN),
	CUSTOMER_END_CART(12, "customer_end_cart", TextFormatting.DARK_RED),
	RETURN_STOCK_ADDED(13, "return_stock_added", TextFormatting.GREEN),
	RETURN_STOCK_REMOVED(14, "return_stock_removed", TextFormatting.RED);
	...
	public boolean includeTextInString() {
		if (getId() == EnumLogType.WITHDRAW_BALANCE.getId()
				|| getId() == EnumLogType.CUSTOMER_START_CART.getId()
				|| getId() == EnumLogType.CUSTOMER_END_CART.getId()) {
			return true;
		}
		return false;
	}

package com.fureniku.econ.blocks;
        	...
        	if (player.isSneaking()) {
    			...
    			if (item.getItem() instanceof ItemMoney) {
    				...
    				if (econ.addMoney(player, money.moneyValue)) {
        				player.sendMessage(new TextComponentString(TextFormatting.GOLD + EconUtils.formatBalance(money.getMoneyValue()) + TextFormatting.GREEN + " Deposited! Your balance is now " + TextFormatting.GOLD + EconUtils.formatBalance(econ.getBalance(player))));
